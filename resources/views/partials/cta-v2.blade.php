<section class="py-32 lg:py-40 relative overflow-hidden"
    ...
    <div class="relative max-w-4xl mx-auto px-6 lg:px-8 text-center">
        ...
        <h2 class="text-5xl lg:text-7xl font-display leading-tight mb-6" data-animate="fade-up">
            Pronto para transformar o seu negócio?
        </h2>

        <p class="text-lg lg:text-xl text-white/70 max-w-2xl mx-auto mb-12" data-animate="fade-up">
